...
export const ONBOARDING_OPERATOR_LABELS = {
  en: {
    ...
    "operator.claim.title": "Claim your restaurant",
    ...
    "operator.claim.claimButton": "Claim Profile",
    "operator.claim.claiming": "Claiming…",
    "operator.claim.successTitle": "You're on Menuply.",
    "operator.claim.successBody":
      "{name} is linked. Next, add or review your menu so diners can discover what you serve.",
    "operator.claim.addMenu": "Add your menu",
    "operator.claim.goDashboard": "Explore dashboard",
    ...
    "signup.entry.title": "Your Menu. More Ways to Be Discovered.",
    "signup.entry.subtitle":
      "Menuply connects your restaurant menu to a social food experience.",
    ...
    "signup.account.pageTitle": "Create your Menuply account",
    "signup.account.pageSubtitle": "Get your restaurant on Menuply and start building your presence in the community.",
    "signup.account.pageSubtitleDetails":
      "Get your restaurant on Menuply and start building your presence in the community.",
    "signup.account.selectedPlan": "Joining",
    ...
    "signup.account.choosePlanFirst": "Start restaurant signup to continue.",
    "signup.account.goToPricing": "Sign Up",
    ...
    "signup.account.plan.standard": "Menuply",
    "signup.account.plan.standard_free": "Menuply",
    "signup.account.plan.published": "Menuply",
    "signup.account.plan.published_free": "Menuply",
    "signup.account.plan.verified": "Menuply",
    "signup.account.plan.starter": "Menuply",
    ...
    "signup.entry.foodTruckSignup": "Sign up",
  ...
  es: {
    ...
    "operator.claim.title": "Reclama tu restaurante",
    "operator.claim.subtitle":
      "Reclama el perfil de tu restaurante para gestionar tu información, menú y presencia en Menuply.",
    ...
    "operator.claim.claimButton": "Reclamar perfil",
    "operator.claim.claiming": "Reclamando…",
    "operator.claim.successTitle": "Ya estás en Menuply.",
    "operator.claim.successBody":
      "{name} está vinculado. Ahora añade o revisa tu menú para que los comensales descubran lo que sirves.",
    "operator.claim.addMenu": "Añade tu menú",
    "operator.claim.goDashboard": "Explorar el panel",
    ...
    "signup.entry.title": "Tu menú. Más formas de ser descubierto.",
    "signup.entry.subtitle":
      "Menuply conecta el menú de tu restaurante con una experiencia social de comida.",
    ...
    "signup.entry.invite.differentiator":
      "Pon tu menú donde ocurre la conversación sobre la comida.",
    "signup.entry.invite.steps":
    ...
    "signup.account.pageSubtitle": "Continúa con Menuply. Completa tu cuenta para continuar.",
    "signup.account.pageSubtitleDetails":
      "Introduce los datos de tu restaurante para continuar.",
    "signup.account.selectedPlan": "Te unes a",
    "signup.account.changePlan": "Volver",
    ...
    "signup.account.choosePlanFirst": "Inicia el registro del restaurante para continuar.",
    "signup.account.goToPricing": "Registrarse",
  ...
  zh: {
    ...
    "operator.claim.title": "认领你的餐厅",
    "operator.claim.subtitle": "认领餐厅资料，以便在 Menuply 上管理信息、菜单和展示。",
    ...
    "operator.claim.claimButton": "认领资料",
    "operator.claim.claiming": "认领中…",
    "operator.claim.successTitle": "你已加入 Menuply。",
    "operator.claim.successBody":
      "{name} 已关联。接下来请添加或核对菜单，方便食客发现你提供的菜品。",
    "operator.claim.addMenu": "添加菜单",
    "operator.claim.goDashboard": "探索控制台",
    ...
    "signup.entry.title": "你的菜单。更多被发现的方式。",
    "signup.entry.subtitle": "Menuply 将餐厅菜单连接到社交美食体验。",
    ...
    "signup.entry.plan.verified.cta": "注册",
    "signup.entry.plan.pro.name": "Pro",
    ...
    "signup.account.pageSubtitle": "继续使用 Menuply。请完成账户信息以继续。",
    "signup.account.pageSubtitleDetails": "填写餐厅信息以继续。",
    "signup.account.selectedPlan": "正在加入",
    "signup.account.changePlan": "返回",
    ...
    "signup.account.choosePlanFirst": "请先开始餐厅注册以继续。",
    "signup.account.goToPricing": "注册",
