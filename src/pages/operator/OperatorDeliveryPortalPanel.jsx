...
export default function OperatorDeliveryPortalPanel({ embedded = false }) {
  ...
  if (!selectedRestaurant) {
    return (
      <div data-testid="delivery-portal-panel" style={{ color: "#5b6675" }}>
        Select a restaurant to manage delivery settings.
      </div>
    );
  }
