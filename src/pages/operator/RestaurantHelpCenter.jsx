...
const OPERATIONS_SECTIONS = [
  {
    ...
    articles: [
      ...
      },
      {
        ...
        points: [
          "Overview mode lists all menus. From here, create a new menu with Add via Upload (PDF or page photos, 20 MB max per file) or select a menu and click Edit to enter full edit mode.",
    ...
    articles: [
      {
        ...
        summary: "Operator steps to scan a printed menu, plus file types and the 20 MB size limit.",
        updated: "2026-08-11",
        points: [
          ...
          "Upload usually one PDF, or clear photos of each printed page. Accepted: PDF, JPG, JPEG, PNG, WEBP. Maximum 20 MB per file. HEIC/iPhone HEIF is not accepted.",
          ...
          "If the file is over 20 MB, Menuply rejects it. The error should read: \"File is too large. Maximum is 20 MB.\" Compress the PDF or photograph each page instead of one giant PDF.",
      ...
      },
      {
        ...
        points: [
          ...
          "Menu scan (PDF/photo of printed menu) — Add via Upload only. Builds menu text; does not attach dish photos to items. PDF/JPG/PNG/WEBP up to 20 MB per file. Oversize error: \"File is too large. Maximum is 20 MB.\"",
    ...
    articles: [
      ...
      },
      {
        ...
        points: [
          ...
          "Check file size limits: logo 5 MB, banner 8 MB, hero 5 MB, dish 10 MB, billboard 5 MB, menu scan 20 MB per file. Menu scan oversize error: \"File is too large. Maximum is 20 MB.\"",
      ...
      },
      {
        ...
        summary: "Use clean inputs, stay under 20 MB, and isolate the exact failure.",
        updated: "2026-08-11",
        points: [
          "Accepted menu scans: PDF, JPG, JPEG, PNG, or WEBP. Maximum 20 MB per file. Usually one PDF, or one photo per printed page.",
          "If the error is \"File is too large. Maximum is 20 MB,\" compress the PDF or photograph each page. Do not retry the same oversized file.",
