...
const OPERATIONS_SECTIONS = [
  {
    ...
    articles: [
      ...
      },
      {
        ...
        points: [
          "Overview mode lists all menus. From here, create a new menu with Add via Upload (PDF or page photos, 100 MB max per file) or select a menu and click Edit to enter full edit mode.",
  ...
  },
  {
    ...
    articles: [
      {
        id: "how-to-upload-a-menu",
        title: "How to Upload a Menu",
        summary: "Operator steps to scan a printed menu, plus file types and the 100 MB size limit.",
        updated: "2026-08-11",
        points: [
          "Sign in at /operator/login, then open Menu Lab from the sidebar (/operator/menulab).",
          "In overview, choose Add via Upload (or Upload PDF / Photo / Camera when those controls are shown). Confirm menu name and type.",
          "Upload usually one PDF, or clear photos of each printed page. Accepted: PDF, JPG, JPEG, PNG, WEBP. Maximum 100 MB per file. HEIC/iPhone HEIF is not accepted.",
          "Click Upload (or Upload & Parse). Wait for processing. Then review OCR items and open Menu Worksheet to correct names, sections, descriptions, and Menuply Price.",
          "If the file is over 100 MB, Menuply rejects it. The error should read: \"File is too large. Maximum is 100 MB.\" Compress the PDF or photograph each page instead of one giant PDF.",
          "A menu scan builds menu text only — it does not attach dish photos. Search Knowledge Base: \"How do I upload a menu?\"",
          "Several printed menus (lunch, dinner, bar): + New in Menu Lab or + Add Another Menu in Owner Menu Manager. Tabs stay on the same screen. Set default, Activate/Deactivate, and ← Order / Order → for display order.",
        ],
      },
      {
        id: "photos-and-logos",
        ...
        points: [
          ...
          "Menu scan (PDF/photo of printed menu) — Add via Upload only. Builds menu text; does not attach dish photos to items. PDF/JPG/PNG/WEBP up to 100 MB per file. Oversize error: \"File is too large. Maximum is 100 MB.\"",
    ...
    articles: [
      ...
      },
      {
        ...
        points: [
          ...
          "Check file size limits: logo 5 MB, banner 8 MB, hero 5 MB, dish 10 MB, billboard 5 MB, menu scan 100 MB per file. Menu scan oversize error: \"File is too large. Maximum is 100 MB.\"",
      ...
      },
      {
        ...
        summary: "Use clean inputs, stay under 100 MB, and isolate the exact failure.",
        updated: "2026-08-11",
        points: [
          "Accepted menu scans: PDF, JPG, JPEG, PNG, or WEBP. Maximum 100 MB per file. Usually one PDF, or one photo per printed page.",
          "If the error is \"File is too large. Maximum is 100 MB,\" compress the PDF or photograph each page. Do not retry the same oversized file.",
          "Check whether the source file is clear, complete, and well lit. Blurry or cropped pages produce weak OCR.",
          "If uploads stall after a valid file, note whether the issue is file quality, processing time, or wrong mapping.",
          "When escalating, include file type, approximate file size, restaurant name, and the exact error text. Search KB: \"How do I upload a menu?\"",
        ],
      },
    ],
  },
