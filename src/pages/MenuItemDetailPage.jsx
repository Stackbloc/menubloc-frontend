...
// ⛔ DESIGN LOCK — 2026-06-09: These label/eye colors are locked by user approval.
// DO NOT change colors, layout, or VerdictBlock structure without explicit user approval.
const VERDICT_THEMES = {
  "Compatible with a health-conscious diet":      { bg: "#0A0A0A", label: "rgba(196,244,214,0.97)", eye: "rgba(196,244,214,0.62)" },
  "Suitable for frequent/regular consumption":    { bg: "#0A0A0A", label: "rgba(184,216,255,0.97)", eye: "rgba(184,216,255,0.62)" },
  // Client-side computed labels from cardVerdict.js (sentence-case)
  "Suitable for frequent consumption":            { bg: "#0A0A0A", label: "rgba(184,216,255,0.97)", eye: "rgba(184,216,255,0.62)" },
  "Solid nutritional profile — one consideration":{ bg: "#0A0A0A", label: "rgba(182,240,252,0.97)", eye: "rgba(182,240,252,0.62)" },
  "Best in moderation":                           { bg: "#0A0A0A", label: "rgba(255,220,155,0.97)", eye: "rgba(255,220,155,0.62)" },
  "Best suited for occasional consumption":       { bg: "#0A0A0A", label: "rgba(255,192,174,0.97)", eye: "rgba(255,192,174,0.62)" },
  "Suitable for occasional consumption":          { bg: "#0A0A0A", label: "rgba(255,192,174,0.97)", eye: "rgba(255,192,174,0.62)" },
  "Indulgent":                                    { bg: "#0A0A0A", label: "rgba(254,215,170,0.97)", eye: "rgba(254,215,170,0.62)" },
};
