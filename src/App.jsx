...
import DinerProfilePage from "./pages/consumer/DinerProfilePage.jsx";
...
import DinerSocialEventDetailPage from "./pages/consumer/DinerSocialEventDetailPage.jsx";
...
import HomemadeDishDetailPage from "./pages/HomemadeDishDetailPage.jsx";
import HomemadeDishComposePage from "./pages/consumer/homemade/HomemadeDishComposePage.jsx";
import MonthInFoodPage from "./pages/consumer/monthInFood/MonthInFoodPage.jsx";
import MyHighlightsPage from "./pages/consumer/myMenuply/MyHighlightsPage.jsx";
...
import OwnerFeedInviteQr from "./pages/owner/OwnerFeedInviteQr.jsx";
  ...
  return (
    <>
      ...
      <SentryRoutes>
        ...
        <Route
          path="/venues/:slug"
          element={crmHost ? <HostRouteRedirect to="/crm" /> : <VenueProfilePage />}
        />
        <Route
        ...
        <Route path="/diners/:userId" element={<DinerProfilePage />} />
        ...
        <Route path="/my-menuply/highlights" element={crmHost ? <HostRouteRedirect to="/crm" /> : <MyHighlightsPage />} />
        <Route path="/my-menuply/homemade/create" element={crmHost ? <HostRouteRedirect to="/crm" /> : <HomemadeDishComposePage />} />
        <Route path="/homemade-dishes/:id" element={crmHost ? <HostRouteRedirect to="/crm" /> : <HomemadeDishDetailPage />} />
        ...
        <Route path="/account/social-events/:eventId" element={crmHost ? <HostRouteRedirect to="/crm" /> : <DinerSocialEventDetailPage />} />
        ...
        <Route path="/owner/feed-invite-qr" element={crmHost ? <HostRouteRedirect to="/crm" /> : <OwnerRoute><OwnerFeedInviteQr /></OwnerRoute>} />
