...
export const TERMS_DOCUMENT = {
  ...
  sections: [
    ...
    },
    {
      heading: "Contact",
      paragraphs: [
        "Questions about these Terms of Use may be sent to Stackbloc Corporation at legal@menuply.com.",
      ],
    },
  ],
};
...
export const PRIVACY_DOCUMENT = {
  ...
  sections: [
    ...
    },
    {
      ...
      paragraphs: [
        "We use information to operate the platform, create and maintain accounts, process orders, route information to restaurants for fulfillment, support customer service, prevent fraud, improve product performance, and comply with legal obligations.",
        "We may also use information to communicate transactional updates, product notices, security alerts, and other service-related messages.",
      ],
    },
    {
    ...
    },
    {
      ...
      paragraphs: [
        "When you place an order, we share the information reasonably necessary for fulfillment with the restaurant, including your name, contact information, order contents, fulfillment type, and pickup or delivery details.",
        "We may also share information with service providers that support hosting, analytics, customer support, communications, payments, fraud prevention, or infrastructure operations on our behalf.",
      ],
    },
    {
      heading: "Cookies and analytics",
      paragraphs: [
        "We use cookies, similar technologies, and analytics tools to remember preferences, measure traffic, understand usage patterns, improve performance, and support marketing or attribution activities where permitted by law.",
        "You can manage certain browser-level cookie preferences through your browser settings, though some features may not function properly if essential cookies are disabled.",
      ],
    },
    {
      heading: "Security",
      paragraphs: [
        "We use administrative, technical, and physical safeguards designed to protect personal information. No security measure is perfect, and we cannot guarantee absolute security.",
      ],
    },
    {
      heading: "Retention",
      paragraphs: [
        "We retain personal information for as long as reasonably necessary to provide the service, maintain records, resolve disputes, enforce agreements, comply with law, and protect the platform and its users.",
      ],
    },
    {
      ...
      paragraphs: [
        ...
        "Requests may be sent to legal@menuply.com. We may request information needed to verify your identity before responding.",
      ],
    },
    {
      heading: "Children",
    ...
    },
    {
      ...
      paragraphs: [
        ...
        "Privacy questions or requests may be sent to Stackbloc Corporation at legal@menuply.com.",
      ],
    },
  ],
};
...
export const MERCHANT_TERMS_DOCUMENT = {
  ...
  sections: [
    ...
    },
    {
      heading: "Contact",
      paragraphs: [
        "Questions about these Merchant Terms of Service may be sent to Stackbloc Corporation at legal@menuply.com.",
      ],
    },
  ],
};
...
export const SUBSCRIPTION_TERMS_DOCUMENT = {
  ...
  sections: [
    ...
    },
    {
      heading: "Contact",
      paragraphs: [
        "Questions about restaurant plan billing may be sent to Stackbloc Corporation at legal@menuply.com.",
      ],
    },
  ],
};
