...
const ROUTES = [
  ...
  {
    name: "signup-account",
    path: "/restaurant/signup/account",
    selector: "body",
    bodyContains: [
      "restaurant",
      "Restaurant",
    ...
    description: "restaurant signup account step",
  },
  {
    name: "signup-free-profile",
    path: "/restaurant/signup/free-profile",
    selector: "body",
    bodyContains: ["profile", "Profile", "restaurant", "Restaurant", "Join", "join"],
    description: "free profile signup",
  },
  {
    name: "consumer-login",
    path: "/account/login",
    selector: "body",
    bodyContains: ["Email", "email", "Sign in", "sign in", "Log in", "log in", "Password", "password"],
  ...
  },
  {
    ...
    path: "/account/signup",
    selector: "body",
    bodyContains: ["Email", "email", "Create account", "Sign up", "sign up", "Password", "password"],
    description: "consumer signup",
  },
  {
    name: "operator-login",
    path: "/operator/login",
  ...
  },
  {
    ...
    selector: "body",
    bodyContains: ["operator", "Operator", "account", "Account", "Email", "email", "Password", "password"],
    description: "operator signup",
  },
  {
    name: "owner-login",
    path: "/owner/login",
  ...
  {
    name: "foodtruck-signup",
    path: "/foodtruck/signup",
    selector: "body",
    bodyContains: ["truck", "Truck", "food", "Food", "account", "Account", "Create"],
    description: "food truck signup",
  },
  {
    name: "build-info",
    path: "/build-info",
