...
| Field | Value |
|-------|-------|
| Deployment | `menubloc-frontend-kp8teptm7-menuply.vercel.app` |
| Live bundle | `index-DCAdIaFJ.js` |
| Aliases | `menuply.com`, `www.menuply.com`, `crm.menuply.com`, `venues.menuply.com` |
| Locked | 2026-08-25 (FE `598b299` hybrid camera; BE `e53dc7a4`) |
| Notes | Current tip supersedes plan-windows tip `2q95zr9z7` / `Bc6lB1Ap`. Deploy/push only from clean `menubloc-frontend-main` @ `main`. Tip lock: `docs/guardrails/2026-08-24_production-tip-lock-atomic-contract.md`. |
