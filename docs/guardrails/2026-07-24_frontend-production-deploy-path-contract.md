...
| Locked | 2026-08-24 (diner video record Stop fix `ef4420d`; BE `d15c9260`) |
| Notes | Current tip supersedes eating-video-compose tip `5hahxk6st` / `CYtSPDxP`. Deploy/push only from clean `menubloc-frontend-main` @ `main`. Tip lock: `docs/guardrails/2026-08-24_production-tip-lock-atomic-contract.md`. |
