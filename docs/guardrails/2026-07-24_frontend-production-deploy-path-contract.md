...
| Locked | 2026-08-24 (eating camera flip + hard-press delete `9acc99a`; BE `9901800b`) |
| Notes | Current tip supersedes grouped-X tip `cey0mwaa7` / `BXhQToJa`. Deploy/push only from clean `menubloc-frontend-main` @ `main`. Tip lock: `docs/guardrails/2026-08-24_production-tip-lock-atomic-contract.md`. |
