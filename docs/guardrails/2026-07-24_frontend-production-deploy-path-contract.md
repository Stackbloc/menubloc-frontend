...
| Locked | 2026-08-25 (FE `7555de4` desktop MediaRecorder; BE `8ccf1071`) |
| Notes | Desktop webcam Record restored; phones keep OS capture. Supersedes `l1u8ibp3k` / `D3_g8ZsE`. |
