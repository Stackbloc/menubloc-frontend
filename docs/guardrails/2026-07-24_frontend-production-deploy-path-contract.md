...
| Locked | 2026-08-25 (FE `f6f663e` incl. diner capability `e25acc5`; BE `dadb5bf9`) |
| Notes | Current tip supersedes hybrid-camera tip `kp8teptm7` / `DCAdIaFJ`. Deploy/push only from clean `menubloc-frontend-main` @ `main`. Tip lock: `docs/guardrails/2026-08-24_production-tip-lock-atomic-contract.md`. |
