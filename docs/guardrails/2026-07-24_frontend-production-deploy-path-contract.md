...
| Locked | 2026-08-25 (FE `1502c00` sticky title+feed / TikTok reel / poster fallbacks; BE `bbba2655`) |
| Notes | Green My Menuply sticky with live feed; fullscreen swipe-up + Exit; meal still fallbacks. Supersedes `g0i59i1u8` / `Ckdz5Gru`. |
