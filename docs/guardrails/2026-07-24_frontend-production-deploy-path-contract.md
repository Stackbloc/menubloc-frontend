...
| Locked | 2026-08-24 (video upload Failed-to-fetch fix `bc104af`; BE `9174dbc9`) |
| Notes | Current tip supersedes video-review tip `rh505od55` / `B1mo46YC`. Deploy/push only from clean `menubloc-frontend-main` @ `main`. Tip lock: `docs/guardrails/2026-08-24_production-tip-lock-atomic-contract.md`. |
