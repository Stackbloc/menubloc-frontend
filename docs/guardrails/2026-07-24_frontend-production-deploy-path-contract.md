...
| Locked | 2026-08-25 (FE `1ef546c` ShareModal lift; BE `b0781d7a`) |
| Notes | Current tip supersedes `fntkuipor` (same bundle, pre-ShareModal). Deploy/push only from clean `menubloc-frontend-main` @ `main`. Tip lock: `docs/guardrails/2026-08-24_production-tip-lock-atomic-contract.md`. |
