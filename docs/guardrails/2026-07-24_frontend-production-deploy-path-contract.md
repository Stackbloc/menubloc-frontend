...
| Locked | 2026-08-21 (meal photos + long-press Delete `b46d3ed`; BE `a24c775c`) |
| Notes | Current tip supersedes billboard-fallback tip `a304s1jgd` / `CvkADiUB` and dish-hero tip `7jj41b2cs` / `Dy18r6lv`. Deploy/push only from clean `menubloc-frontend-main` @ `main`. |
