...
| Locked | 2026-08-25 (FE `a53280c` Video-first camera; BE `d3449e93` diner-media) |
| Notes | Video\|Photo default; label→capture Record video. Supersedes `80fy979wl` / `BfPQn7JE`. |
