...
| Field | Value |
|-------|-------|
| Deployment | `menubloc-frontend-7ljmgxgm2-menuply.vercel.app` |
| Live bundle | `index-CdB7Wbvg.js` |
| Aliases | `menuply.com`, `www.menuply.com`, `crm.menuply.com`, `venues.menuply.com` |
| Locked | 2026-08-20 (What I Ate meal board + Upcoming Plans `ff5f3ea`; tip probe: apex/www = `index-CdB7Wbvg.js`) |
| Notes | Current tip supersedes Want video / Month in Food tip `ip7mqupae` / `rdsNgKEW`. Deploy/push only from clean `menubloc-frontend-main` @ `main`. |
