...
| Locked | 2026-08-20 (Month in Food platform share `cbc7728`; tip probe: apex/www = `index-RmW9q_Gr.js`) |
| Notes | Current tip supersedes My Menuply hub access tip `k2hpeyh3s` / `DygwUgB7`. Deploy/push only from clean `menubloc-frontend-main` @ `main`. |
