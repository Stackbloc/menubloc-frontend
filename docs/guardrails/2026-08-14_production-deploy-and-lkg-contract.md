...
| Git commit | `61946c9` — feed deals chrome + me clusters/menu upload — feed video-only hybrid ConsumerCameraSheet recorder — feed center X video create + plan video attach — video-first parallel `/feed` shell (FEED\|EATING\|EVENTS\|ME); HomeNext remains `/` |
| Vercel deployment | `menubloc-frontend-ipnr8htpu-menuply.vercel.app` |
...
npx vercel alias set menubloc-frontend-ipnr8htpu-menuply.vercel.app www.menuply.com
npx vercel alias set menubloc-frontend-ipnr8htpu-menuply.vercel.app crm.menuply.com
npx vercel alias set menubloc-frontend-ipnr8htpu-menuply.vercel.app venues.menuply.com
