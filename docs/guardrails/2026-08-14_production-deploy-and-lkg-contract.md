...
| Git commit | `4b147d5` — eating restaurant + menu item fields for ate/want — feed deals chrome + me clusters/menu upload — feed video-only hybrid ConsumerCameraSheet recorder — feed center X video create + plan video attach — video-first parallel `/feed` shell (FEED\|EATING\|EVENTS\|ME); HomeNext remains `/` |
| Vercel deployment | `menubloc-frontend-cyokwi8r6-menuply.vercel.app` |
| Live bundle | `index--02s1w-D.js` |
...
npx vercel alias set menubloc-frontend-cyokwi8r6-menuply.vercel.app www.menuply.com
npx vercel alias set menubloc-frontend-cyokwi8r6-menuply.vercel.app crm.menuply.com
npx vercel alias set menubloc-frontend-cyokwi8r6-menuply.vercel.app venues.menuply.com
