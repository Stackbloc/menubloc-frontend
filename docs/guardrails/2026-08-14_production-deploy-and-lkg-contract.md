...
## CURRENT LAST KNOWN GOOD (live production — 2026-09-14)
...
| Git on origin | `0c7c6cbf` — diner Catch Me + Waiter LDL |
| Live health SHA | `0c7c6cbf8f489cf1efcd06297edab55805b142e3` |
| Health URL | `https://menubloc-backend-production.up.railway.app/health` |
| `commit_hash` | `0c7c6cbf…` |
| DB | migrations through `0331` (`consumer_catch_me`); **0305** `eat_invitations.attached_menu_id` applied 2026-09-03 |
| Smoke | BE Catch Me CPD 2026-09-14 (health `0c7c6cbf`, smoke 24 PASS); FE tip `a487lxzng` / `index-CBKkBfRd.js` |

### Restore current tip (if tip-gate fails mid-change)

```bash
cd /Users/andrebarber/Desktop/menubloc/menubloc-frontend-main
npx vercel alias set menubloc-frontend-a487lxzng-menuply.vercel.app menuply.com
npx vercel alias set menubloc-frontend-a487lxzng-menuply.vercel.app www.menuply.com
npx vercel alias set menubloc-frontend-a487lxzng-menuply.vercel.app crm.menuply.com
npx vercel alias set menubloc-frontend-a487lxzng-menuply.vercel.app venues.menuply.com
...
| Field | Value |
|-------|-------|
| Deployment | `menubloc-frontend-le02p8919-menuply.vercel.app` |
| Live bundle | `index-zseFoUke.js` |
