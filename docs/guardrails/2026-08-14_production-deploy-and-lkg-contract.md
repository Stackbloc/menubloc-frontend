...
## CURRENT LAST KNOWN GOOD (live production — 2026-09-16)
...
| Git on origin | `d41241b0` — Video Manager food-type tagging + canonical-menu place pickers |
| Live health SHA | `d41241b066edcc12518d358ca25ffd870ebc0010` |
| Health URL | `https://menubloc-backend-production.up.railway.app/health` |
| `commit_hash` | `d41241b0…` |
| DB | migrations through `0334` (`video_asset_metadata.food_form` + `food_form_catalog_terms`) |
| Smoke | Picker CPD 2026-09-15 (`cpd-be.sh` RESULT=PASS, smoke 27, health `d41241b0`) |

### Restore current tip (if tip-gate fails mid-change)

```bash
cd /Users/andrebarber/Desktop/menubloc/menubloc-frontend-main
npx vercel alias set menubloc-frontend-hwaxpf2mr-menuply.vercel.app menuply.com
npx vercel alias set menubloc-frontend-hwaxpf2mr-menuply.vercel.app www.menuply.com
npx vercel alias set menubloc-frontend-hwaxpf2mr-menuply.vercel.app crm.menuply.com
npx vercel alias set menubloc-frontend-hwaxpf2mr-menuply.vercel.app venues.menuply.com
...
| Field | Value |
|-------|-------|
| Deployment | `menubloc-frontend-8d1ow719j-menuply.vercel.app` |
| Live bundle | `index-Be1VYPLO.js` |
