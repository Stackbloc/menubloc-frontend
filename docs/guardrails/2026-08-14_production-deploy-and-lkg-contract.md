...
| Git commit | `2b4e9b9` — feed eating tab real compose actions — eating restaurant + menu item fields for ate/want — feed deals chrome + me clusters/menu upload — feed video-only hybrid ConsumerCameraSheet recorder — feed center X video create + plan video attach — video-first parallel `/feed` shell (FEED\|EATING\|EVENTS\|ME); HomeNext remains `/` |
| Vercel deployment | `menubloc-frontend-by4qfdlly-menuply.vercel.app` |
| Live bundle | `index-DhpQrWbK.js` |
...
npx vercel alias set menubloc-frontend-by4qfdlly-menuply.vercel.app menuply.com
npx vercel alias set menubloc-frontend-by4qfdlly-menuply.vercel.app www.menuply.com
npx vercel alias set menubloc-frontend-by4qfdlly-menuply.vercel.app crm.menuply.com
npx vercel alias set menubloc-frontend-by4qfdlly-menuply.vercel.app venues.menuply.com
